...
public class AndroidTtsService_MyListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MauiAppMain.AndroidTtsService+MyListener, MauiAppMain", AndroidTtsService_MyListener.class, __md_methods);
	}

	public AndroidTtsService_MyListener ()
	{
		super ();
		if (getClass () == AndroidTtsService_MyListener.class) {
			mono.android.TypeManager.Activate ("MauiAppMain.AndroidTtsService+MyListener, MauiAppMain", "", this, new java.lang.Object[] {  });
		}
	}
